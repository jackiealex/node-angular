define(['app/index'], function(app) {
    ...
    app.register.controller('TemplateListController', ['$scope', '$ocLazyLoad',
            ...
            angular.module('reimApp', ['ng-sortable', 'ng-dropdown']).controller('templateListController', ["$http", "$scope", "$element", "$timeout",
                function($http, $scope, $element, $timeout) {
                    function loadPageData() {
                        return $.when(Utils.api('/company/get_template_list'), Utils.api('/company/get_template_types')).done(function(rsTemplate, rsTypes) {
                    ...
                    $scope.onAddTemplate = function(e) {
                        ...
                        doClearOpenTemplateData().done(function(state) {
                            ...
                            $.when.apply(null, requestArray).done(function(rs, rsDefault) {
                                // update arraycache
                                if (!rs['id'] || rs['id'] == -1) {
